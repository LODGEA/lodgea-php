...
/**
 * PropertiesPropertyIdGet200ResponsePropertyCancellationGracePeriod Class Doc Comment
 *
 * @category Class
 ...
 */
class PropertiesPropertyIdGet200ResponsePropertyCancellationGracePeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_properties__propertyId__get_200_response_property_cancellationGracePeriod';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hours_after_booking'] === null) {
            $invalidProperties[] = "'hours_after_booking' can't be null";
        }
        if ($this->container['weeks_before_check_in'] === null) {
            $invalidProperties[] = "'weeks_before_check_in' can't be null";
        }
     ...
     *
     * @param float $hours_after_booking The number of hours after booking that the cancellation grace period starts.
     *
     * @return self
     */
     ...
     *
     * @param float $weeks_before_check_in The number of weeks before check-in that the cancellation grace period starts.
     *
     * @return self
     */
