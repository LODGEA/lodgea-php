...
/**
 * PropertiesPropertyIdGet200ResponsePropertyPropertyInfoMessageListInner Class Doc Comment
 *
 * @category Class
 * @package  com.lodgea
 * @author   OpenAPI Generator team
 ...
 */
class PropertiesPropertyIdGet200ResponsePropertyPropertyInfoMessageListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_properties__propertyId__get_200_response_property_propertyInfo_messageList_inner';
     ...
     * Sets language_code
     *
     * @param string $language_code The language of this message.<p>Please note that beside the general restrictions listed below only languages configured during system setup for your respective tenant are allowed.</p><p>See also <a href=\"#isolanguage-codes\">in the appendix</a>.</p>
     *
     * @return self
     */
