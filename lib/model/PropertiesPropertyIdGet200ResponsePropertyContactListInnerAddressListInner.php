...
/**
 * PropertiesPropertyIdGet200ResponsePropertyContactListInnerAddressListInner Class Doc Comment
 *
 * @category Class
 * @package  com.lodgea
 * @author   OpenAPI Generator team
 ...
 */
class PropertiesPropertyIdGet200ResponsePropertyContactListInnerAddressListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_properties__propertyId__get_200_response_property_contactList_inner_addressList_inner';
    ...
    {
        $this->container['address_line'] = $data['address_line'] ?? null;
     ...
     * Sets address_line
     *
     * @param string $address_line The first line of the address for this contact
     *
     * @return self
     */
     ...
     * Sets property_name
     *
     * @param string|null $property_name The name of the property for this contact
     *
     * @return self
     */
     ...
     * Sets city_name
     *
     * @param string $city_name The city of this contact
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code The postal code of this contact
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state/region of this contact
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code The country code of this contact
     *
     * @return self
     */
