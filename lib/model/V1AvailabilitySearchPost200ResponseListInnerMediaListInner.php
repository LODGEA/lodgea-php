...
/**
 * V1AvailabilitySearchPost200ResponseListInnerMediaListInner Class Doc Comment
 *
 * @category Class
 * @package  com.lodgea
 * @author   OpenAPI Generator team
 ...
 */
class V1AvailabilitySearchPost200ResponseListInnerMediaListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_availability_search_post_200_response_list_inner_mediaList_inner';
    ...
    {
        $this->container['tag_code_list'] = $data['tag_code_list'] ?? null;
    ...
    {
        return $this->container['tag_code_list'];
    }

    /**
     * Sets tag_code_list
     *
     * @param float[]|null $tag_code_list tag_code_list
     *
     * @return self
     */
    public function setTagCodeList($tag_code_list)
    {
        $this->container['tag_code_list'] = $tag_code_list;
