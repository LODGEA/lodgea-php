...
class PropertyApi
{
    ...
    /**
     * Operation v1PropertyListPost
     *
     * List properties by a specific keyword
     *
     * @param  \com.lodgea\com.lodgea.model\PropertyList $property_list Provide the search keyword and optionally a page token to fetch further responses. The page token can be added if additional results should be returned. It is a base64 encoded dictionary and included in the first response in case not all results were delivered (required)
     *
     * @throws \com.lodgea\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com.lodgea\com.lodgea.model\V1PropertyListPost200Response
     */
    public function v1PropertyListPost($property_list)
    {
        list($response) = $this->v1PropertyListPostWithHttpInfo($property_list);
        return $response;
    }

    /**
     * Operation v1PropertyListPostWithHttpInfo
     *
     * List properties by a specific keyword
     *
     * @param  \com.lodgea\com.lodgea.model\PropertyList $property_list Provide the search keyword and optionally a page token to fetch further responses. The page token can be added if additional results should be returned. It is a base64 encoded dictionary and included in the first response in case not all results were delivered (required)
     ...
     * @throws \com.lodgea\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com.lodgea\com.lodgea.model\V1PropertyListPost200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1PropertyListPostWithHttpInfo($property_list)
    {
        $request = $this->v1PropertyListPostRequest($property_list);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\com.lodgea\com.lodgea.model\V1PropertyListPost200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\com.lodgea\com.lodgea.model\V1PropertyListPost200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\com.lodgea\com.lodgea.model\V1PropertyListPost200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\com.lodgea\com.lodgea.model\V1PropertyListPost200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com.lodgea\com.lodgea.model\V1PropertyListPost200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation v1PropertyListPostAsync
     *
     * List properties by a specific keyword
     *
     * @param  \com.lodgea\com.lodgea.model\PropertyList $property_list Provide the search keyword and optionally a page token to fetch further responses. The page token can be added if additional results should be returned. It is a base64 encoded dictionary and included in the first response in case not all results were delivered (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1PropertyListPostAsync($property_list)
    {
        return $this->v1PropertyListPostAsyncWithHttpInfo($property_list)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1PropertyListPostAsyncWithHttpInfo
     *
     * List properties by a specific keyword
     *
     * @param  \com.lodgea\com.lodgea.model\PropertyList $property_list Provide the search keyword and optionally a page token to fetch further responses. The page token can be added if additional results should be returned. It is a base64 encoded dictionary and included in the first response in case not all results were delivered (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1PropertyListPostAsyncWithHttpInfo($property_list)
    {
        $returnType = '\com.lodgea\com.lodgea.model\V1PropertyListPost200Response';
        $request = $this->v1PropertyListPostRequest($property_list);
    ...
    /**
     * Create request for operation 'v1PropertyListPost'
     *
     * @param  \com.lodgea\com.lodgea.model\PropertyList $property_list Provide the search keyword and optionally a page token to fetch further responses. The page token can be added if additional results should be returned. It is a base64 encoded dictionary and included in the first response in case not all results were delivered (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v1PropertyListPostRequest($property_list)
    {
        // verify the required parameter 'property_list' is set
        if ($property_list === null || (is_array($property_list) && count($property_list) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_list when calling v1PropertyListPost'
            );
        }

        $resourcePath = '/v1/property/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($property_list)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($property_list));
            } else {
                $httpBody = $property_list;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
